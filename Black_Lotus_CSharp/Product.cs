...
namespace Black_Lotus_CSharp
{
    public partial class Product : Form
    {
        ...
        {
            //Insert Query
            string insertQuery = ("INSERT INTO product(Name,Color,Price,Quantity)VALUES('" + bunifuMetroTextbox_name.Text + "','" + bunifuMetroTextbox_color.Text + "','" + bunifuMetroTextbox_price.Text + "','" + bunifuMetroTextbox_qty.Text + "')");
        ...
        {
            // Update Query
            string updateQuery = "UPDATE product SET Name = '" + bunifuMetroTextbox_name.Text + "',Color = '" + bunifuMetroTextbox_color.Text + "',Price = '" + bunifuMetroTextbox_price.Text + "',Quantity = " + bunifuMetroTextbox_qty.Text + " WHERE ID = " + int.Parse(bunifuMetroTextbox_id.Text);
        ...
        {
            //Delete Query
            string deleteQuery = "DELETE FROM product WHERE ID = " + int.Parse(bunifuMetroTextbox_id.Text);
